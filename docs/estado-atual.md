...
**Cobertura de teste (atual, 2026-07-26):** **164** em `packages/core` · **20** em `packages/db` (novos — o package não tinha suíte) · **158** em `apps/api` (147 + 4 da 014 + 7 de `nutri-patients`) · **24** em `apps/mobile` · **24** em `apps/web` (novos — o app não tinha suíte). _(Baseline imediatamente anterior à 012: core 157 · apps/api 132 = 119 e2e + 13 unit colocados · mobile 24 — com a ressalva de que as 132 só eram verdes **de segunda a sexta**; ver KI-004.)_
