...
**Status**: Draft — método (Q1a → heurística determinística) e base (Q2d → ampliação TACO incluída) **decididos pelo dono** (Sessão 2026-06-10); **vigência (Q1b), taxonomia (Q2c) e Q3 em conversa**
...
- **Pendentes de conversa com o dono** ("vamos conversar melhor"): **Q1b — vigência** do vínculo automático (vale imediatamente × revisão prévia — a colisão Princípio V vs decisoes-produto.md:89), **Q2c — taxonomia canônica** (quais grupos além dos 4, com aprovação do dono) e **Q3 inteira** (ambíguo sem grupo × melhor palpite; multi-grupo; derivação da porção de referência). Os marcadores permanecem nos FR-001/FR-005/FR-006.
...
- **FR-001**: O sistema MUST pré-classificar automaticamente os alimentos da base nos grupos de substituição por **semelhança nutricional**, criando o vínculo alimento↔grupo que a substituição consome _(decisão "sem enlouquecer", decisoes-produto.md:89)_, via **heurística determinística por perfil nutricional** — macro dominante por 100 g + proximidade ao perfil do grupo: testável, explicável pra nutri, sem custo por execução _(Q1a → A, Sessão 2026-06-10; IA/LLM deferida pro import da Fase 4)_. Atenção herdada do gate: 3 dos 4 grupos vigentes compartilham o nutriente-base carboidrato (Carboidratos, Frutas, Vegetais) — a "proximidade ao perfil do grupo" MUST ser definida (no plan) pra distinguir grupos de **mesmo** nutriente-base; macro dominante sozinho não separa banana de arroz. [NEEDS CLARIFICATION: **Q1b — vigência do vínculo automático** (pauta da conversa com o dono): vale **imediatamente** como opção de troca pro paciente, ou exige **revisão humana antes de valer**? Duas fontes decididas colidem: Princípio V/decisoes-produto.md:85 (confirmação clínica antes de valer) × decisoes-produto.md:89 (pré-classifica por default). Recomendação: vale imediatamente (método determinístico/explicável + seed-first) — desvio consciente do espírito do Princípio V, a registrar na aprovação, com gatilho de reversão armado pelo SC-002.]
...
- **SC-002**: Aplicada às cegas aos alimentos dos **vínculos curados vigentes** (gabarito de validação), a classificação automática coincide com o grupo curado em **pelo menos 90%** dos casos. _Número **validado pelo dono** (Sessão 2026-06-10). Caveat operacional mantido: o gabarito atual são 16 vínculos curados (errar 2 já fura os 90%) e 3 dos 4 grupos compartilham o nutriente-base carboidrato (o caso difícil pra heurística) — ampliar o gabarito junto com a base (Q2d) antes de tratar o % como estatisticamente firme. Este SC arma o gatilho de reversão da vigência (Q1b)._
