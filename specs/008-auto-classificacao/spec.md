...
**Status**: Draft — **gate Specify→Plan fechado** (Sessões 2026-06-10): método A, ampliação TACO, vigência imediata, taxonomia = 13 categorias TACO, sem-grupo no ambíguo, grupo único, porção derivada; aguardando o plan
...
- **Q2c — Taxonomia canônica** → **as 13 categorias da TACO**, aprovadas pelo dono: A. Cereais e derivados · B. Verduras, hortaliças e derivados · C. Frutas e derivados · D. Gorduras e óleos · E. Pescados e produtos marinhos · F. Carnes e produtos cárneos · G. Leite e derivados · H. Ovos e produtos derivados · I. Bebidas (alcoólicas e não alcoólicas) · J. Miscelâneas · K. Açúcares e produtos · L. Leguminosas e derivados · M. Nozes e sementes. O **nutriente-base de cada grupo** é definido no plan (proposta de mapeamento aprovada no gate do plan); os 4 grupos do seed são reconciliados com essa taxonomia no plan. _(Encodada no FR-006.)_
...
- **Alimento de perfil misto** (preparações como pizza; itens ambíguos dentro da própria categoria): fica **sem grupo** e é relatado — introcável até decisão humana; a nutri pode vinculá-lo manualmente (Q3a). Nota: com a taxonomia = categorias TACO (Q2c), ovo e leguminosas têm grupo próprio — o caso ambíguo restante é o alimento cujo encaixe/porção não passa na guarda de confiança.
...
- **FR-006**: A execução MUST rodar **em lote sobre a base inteira** (junto da ingestão/atualização da base — relatório de cobertura como saída natural) e classificar **somente nos grupos do sistema** (customização por nutri deferida; o modelo de dados já suporta a coexistência) — _Q2a/Q2b: recomendações não contestadas na Sessão 2026-06-10, adotadas como default vetável_. A **ampliação da ingestão TACO** da allow-list de 23 pra base completa (~590 itens) **MUST fazer parte desta feature** _(Q2d → decisão do dono, Sessão 2026-06-10 — sem ela a US1 seria quase no-op)_. O conjunto canônico de grupos MUST ser a **taxonomia de 13 categorias da TACO aprovada pelo dono** (Q2c, Sessão 2026-06-10 — lista completa na seção Clarifications): Cereais · Verduras/hortaliças · Frutas · Gorduras e óleos · Pescados · Carnes · Leite e derivados · Ovos · Bebidas · Miscelâneas · Açúcares · Leguminosas · Nozes e sementes. Cada grupo carrega um **nutriente-base** definido e aprovado no plan; a reconciliação dos 4 grupos do seed com a taxonomia nova é decisão do plan. Criar grupos além desses segue sendo curadoria, nunca palpite da execução.
...
- **Grupo de substituição**: conjunto de alimentos equivalentes entre si por um **nutriente-base** (a troca preserva esse nutriente). Conjunto canônico = as **13 categorias da TACO** (Q2c); só grupos do sistema nesta execução (Q2b); nutriente-base por grupo definido no plan. O modelo já distingue grupos do sistema de grupos por-nutri.
...
- **Classifica dentro do conjunto canônico aprovado** (as 13 categorias da TACO — Q2c, Sessão 2026-06-10): a execução encaixa alimentos nesses grupos; **criar grupos além deles é curadoria/decisão de produto**, nunca palpite da execução. O nutriente-base de cada grupo (e a reconciliação dos 4 grupos do seed com a taxonomia nova) é definido e aprovado no plan.
