...
- [ ] **T001** Registrar o baseline (core 164 · api 147 · mobile 24) antes de tocar em nada.
- [ ] **T002** Criar o subpath `@bamboo/db/testing`: entrada em `exports` do
...
- [ ] **T003** **[TDD — escrever e VER FALHAR]** Unit do construtor em
...
- [ ] **T004** Implementar `packages/db/src/testing/scenario.ts` até T003 verde, conforme os
...
- [ ] **T005** Rodar `pnpm --filter @bamboo/db test` + `pnpm --filter api test:e2e` (147 —
      ainda intacta) + `tsc`.
...
- [ ] **T006** Reescrever o `beforeAll`/`afterAll`/`afterEach` de
...
- [ ] **T007** Rodar a suíte migrada **isolada** e conferir 8/8; depois a completa (147).
...
- [ ] **T008** ⚠️ **Reprovar o oráculo do KI-002 depois da migração**: repetir a reversão
...
- [ ] **T009** Reescrever o fixture de `apps/api/test/escopo-plano.e2e-spec.ts` (330 linhas)
...
- [ ] **T010** Suíte isolada (7/7) + completa (147). ⚠️ Reconferir SC-007/SC-008 da **012** por
...
- [ ] **T011** Verificar os SCs com comando: **SC-001** as 3 contagens · **SC-002** ≥300 linhas
...
- [ ] **T012** Done-gate: `pnpm lint` + `pnpm format` + `pnpm check-types`.
- [ ] **T013** Atualizar `CONTEXT.md` (termo **cenário de teste**), `docs/estado-atual.md`, o
