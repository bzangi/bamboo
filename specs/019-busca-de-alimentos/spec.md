...
- **FR-007** A busca do paciente é **cliente-side** sobre as alternativas já recebidas: nenhuma
  requisição nova por tecla, nenhum endpoint novo.
...
- **SC-005** O sheet do paciente filtra sem nova requisição (a busca roda sobre o estado carregado).
